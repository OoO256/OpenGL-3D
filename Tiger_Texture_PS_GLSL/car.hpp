...
car::car(void)
{
	body = new object(1, "Data/static_objects/txtdata/cow_triangles_v.txt", TYPE_V);
	...
	wheels[0]->position = glm::vec3(-39, -35, 45);
	wheels[1]->position = glm::vec3(39, -35, 45);
	wheels[2]->position = glm::vec3(-39, -35, -45);
	wheels[3]->position = glm::vec3(39, -35, -45);
